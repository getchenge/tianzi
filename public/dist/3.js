...
var Index = function (_Component) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Index.__proto__ || (0, _getPrototypeOf2.default)(Index)).call.apply(_ref, [this].concat(args))), _this), _this.sync = function () {
      var dispatch = _this.props.dispatch;

      dispatch({
        type: 'users/sync'
      }).then(function () {
        _message3.default.success('粉丝数据更新成功');
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: _style2.default.section, onClick: sync },
            _react2.default.createElement(
              'div',
              { className: _style2.default.sync },
              _react2.default.createElement(_icon2.default, { className: loading ? '' + _style2.default.loading : '', type: 'sync' }),
              ' \u540C\u6B65\u7528\u6237'
            )
          ),
          _react2.default.createElement(
            _router.Link,
            { to: '/send', className: _style2.default.section + ' ' + _style2.default.button },
...
exports.default = (0, _dva.connect)(mapStateToProps)(Index);
...
// module
exports.push([module.i, "html,\nbody,\n#root {\n  height: 100%; }\n\n._3XVD-QJQd0zwtynE9avWrA {\n  width: 100%;\n  height: 100%;\n  margin: 0 auto;\n  max-width: 500px;\n  border-left: 1px solid #666;\n  border-right: 1px solid #666;\n  position: relative; }\n\n._3vCeHSAswP79uCazgXxay {\n  width: 100%;\n  position: absolute;\n  top: 40%;\n  -webkit-transform: translateY(-50%);\n  transform: translateY(-50%);\n  border-bottom: 1px solid #eee; }\n\n._2V6BIz3dfwk1Jhh9W8Vyhi {\n  padding: 20px;\n  text-align: center;\n  border-top: 1px solid #ddd;\n  cursor: pointer;\n  display: block; }\n\n.fec9VnJrIlsq6IlRMu45h {\n  background: #1A9FF9;\n  color: #fff; }\n  .fec9VnJrIlsq6IlRMu45h:hover {\n    opacity: .9;\n    color: #fff; }\n\n@-webkit-keyframes HxXBCxN0P6QTE6Jz8pCY0 {\n  0% {\n    -webkit-transform: rotateZ(0);\n    transform: rotateZ(0); }\n  100% {\n    -webkit-transform: rotateZ(360deg);\n    transform: rotateZ(360deg); } }\n\n@keyframes HxXBCxN0P6QTE6Jz8pCY0 {\n  0% {\n    -webkit-transform: rotateZ(0);\n    transform: rotateZ(0); }\n  100% {\n    -webkit-transform: rotateZ(360deg);\n    transform: rotateZ(360deg); } }\n\n.qvD5XCQl4I-v6a7hepAcu {\n  -webkit-animation: HxXBCxN0P6QTE6Jz8pCY0 3s ease infinite alternate;\n  animation: HxXBCxN0P6QTE6Jz8pCY0 3s ease infinite alternate; }\n", ""]);

// exports
exports.locals = {
	"container": "_3XVD-QJQd0zwtynE9avWrA",
	"nav": "_3vCeHSAswP79uCazgXxay",
	"section": "_2V6BIz3dfwk1Jhh9W8Vyhi",
	"button": "fec9VnJrIlsq6IlRMu45h",
	"loading": "qvD5XCQl4I-v6a7hepAcu",
	"rotate": "HxXBCxN0P6QTE6Jz8pCY0"
};
